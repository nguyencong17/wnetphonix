  ...
  return (
    <>
      <div className="movie-detail">
        <div className="container max-w-[1464px] pl-[44px]">
          <div className="flex gap-10 mt-[64px]">
            <div className="w-full flex flex-col md:flex-row mx-auto md:space-x-8 2xl:-scroll-mt-16">
              ...
              <div className="flex-1 flex flex-col">
                ...
                <p className="text-lg mb-6">
                  Diễn viên :{" "}
                  <span className="text-white">{movie.casts || "Comming"}</span>
                </p>
        ...
        <div className="container max-w-[1400px] mt-8">
          {/* Episodes */}
